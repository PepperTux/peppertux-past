...
void PhysfsSubsystem::find_mount_userdir()
{
  ...
  {
    m_userdir = PHYSFS_getPrefDir("PepperTuxPast","peppertuxpast");
  }
...
if (std::string(PACKAGE_NAME) == "")
  olduserdir = FileSystem::join(physfs_userdir, ".peppertuxpast");
else
...
#ifdef EMSCRIPTEN
  m_userdir = "/home/web_user/.local/share/peppertuxpast/";
#endif
...
Main::run(int argc, char** argv)
{
  ...
  init_emscripten();
	...
	std::string prefpath = SDL_GetPrefPath("PepperTuxPast", "peppertuxpast");
